...
public class Script_juego {
	...
	public static void main(String[] args) {
		...
		//registrar la palabra secreta con un valor vacío
		...
		palabraSecreta += entradaTec.nextLine().toLowerCase(); //se añader lo que inserta el admin al final de el string palabraSecreta
		...
		while (numJds < 2) { //en caso de que el numero de jugadores sea inferior a 2 se revaloriza el int
